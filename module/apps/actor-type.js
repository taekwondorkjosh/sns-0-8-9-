...
export default class ActorTypeConfig extends FormApplication {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["sns", "actor-type", "trait-selector"],
      template: "systems/sns/templates/apps/actor-type.html",
      title: "SNS.CreatureTypeTitle",
      width: 280,
      height: "auto",
      choices: {},
      allowCustom: true,
  ...
  getData(options) {
    ...
    if ( foundry.utils.getType(attr) !== "Object" ) attr = {
      value: (attr in CONFIG.SNS.creatureTypes) ? attr : "humanoid",
      subtype: "",
      swarm: "",
      custom: ""
    };
    ...
    // Populate choices
    const types = {};
    for ( let [k, v] of Object.entries(CONFIG.SNS.creatureTypes) ) {
      types[k] = {
    ...
    return {
      ...
      custom: {
        value: attr.custom,
        label: game.i18n.localize("SNS.CreatureTypeSelectorCustom"),
        chosen: attr.value === "custom"
      },
      subtype: attr.subtype,
      swarm: attr.swarm,
      sizes: Array.from(Object.entries(CONFIG.SNS.actorSizes)).reverse().reduce((obj, e) => {
        obj[e[0]] = e[1];
        return obj;
      }, {}),
